...
const AppContent: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'create' | 'view' | 'archives' | 'settings' | 'personnel' | 'analytics' | 'deployments' | 'users' | 'ai' | 'checklists' | 'my-tasks' | 'clients' | 'ingestion'>('dashboard');
