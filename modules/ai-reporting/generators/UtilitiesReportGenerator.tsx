/**
 * Utilities Report Generator — stub with "Coming Soon" state.
 */
...
const UtilitiesReportGenerator: React.FC<Props> = ({ section }) => (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-8 py-16">
        ...
        <p className="text-slate-500 text-sm">
            The Utilities grid inspection AI generator is in development. <br />
