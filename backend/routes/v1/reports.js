...
import { protect, checkPermission, authorize } from '../../middleware/auth.js';
 ...
 */
router.get('/:id', protect, checkPermission('CREATE_REPORT'), standardLimiter, async (req, res, next) => {
    try {
        const { id } = req.params;
 ...
 */
router.get('/:id/decisions', protect, checkPermission('CREATE_REPORT'), standardLimiter, async (req, res, next) => {
    try {
        const { id } = req.params;
 ...
 * Generate PDF report
 */
router.post('/:id/export/pdf', protect, checkPermission('CREATE_REPORT'), standardLimiter, async (req, res, next) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/:id/export/json', protect, checkPermission('CREATE_REPORT'), standardLimiter, async (req, res, next) => {
    try {
        const { id } = req.params;
