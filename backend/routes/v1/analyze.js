...
import { scoreInspectionAnalysis, scoreAnomalyDetection, scoreMissionReadiness, scoreDailySummary } from '../../services/confidenceScorer.js';
 ...
 */
router.post('/report', protect, authorizePerm('CREATE_REPORT'), aiLimiter, async (req, res, next) => {
    try {
 ...
 */
router.post('/image', protect, authorizePerm('CREATE_REPORT'), aiLimiter, async (req, res, next) => {
    try {
 ...
 */
router.post('/mission', protect, authorizePerm('CREATE_REPORT'), aiLimiter, async (req, res, next) => {
    try {
 ...
 */
router.get('/daily-summary', protect, authorizePerm('VIEW_REPORTS'), aiLimiter, generateDailySummary);
