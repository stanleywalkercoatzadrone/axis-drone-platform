    ...
    return (
        <div className="max-w-5xl mx-auto py-12 px-6">
            <div className="text-center mb-12">
                <h1 className="text-3xl font-bold text-white mb-4">Start New Client Onboarding</h1>
                <p className="text-slate-400">Select a template to begin, or customize your own workflow.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {TEMPLATES.map((tpl) => (
                    ...
                    >
                        ...
                        <tpl.icon className={`w-8 h-8 mb-4 ${tpl.recommended ? 'text-blue-500' : 'text-slate-400'}`} />
                        <h3 className="text-lg font-bold text-white mb-2">{tpl.name}</h3>
                        <p className="text-sm text-slate-400 mb-6 flex-grow">{tpl.description}</p>
