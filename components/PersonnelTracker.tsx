                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-2" onClick={e => e.stopPropagation()}>
                                            ...
                                            >
                                                <MoreHorizontal className="w-4 h-4 text-slate-400 group-hover:hidden" />
                                                <span className="hidden group-hover:inline text-[10px] font-bold uppercase tracking-wider text-red-600">Remove</span>
                                            </button>
                                        </div>
                                    </td>
                                </tr>
