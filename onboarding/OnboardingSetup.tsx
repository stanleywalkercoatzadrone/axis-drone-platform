    ...
    return (
        <div className="max-w-4xl mx-auto py-12 px-6">
            <div className="mb-12 flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 mb-2">Pre-Wizard Setup</h1>
                    <p className="text-slate-600 font-medium">Choose which fields to collect now. Hidden fields remain editable later (Option A).</p>
                </div>
                        ...
                        {config.sections[section.id].enabled && (
                            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                                {section.fields.map(field => (
                                    <div key={field.id} className="flex items-center justify-between p-3 rounded-xl bg-white border border-slate-200 shadow-sm">
                                        <div className="flex items-center gap-3">
                                            {field.locked ? <ShieldCheck className="w-4 h-4 text-slate-400" /> : <div className="w-4" />}
