                ...
                return (
                    <div key={step.id} className="flex flex-col items-center gap-3">
                        ...
                        <div className="text-center">
                            <h3 className={`text-sm font-semibold transition-colors ${isActive ? 'text-slate-900' : 'text-slate-700'}`}>
                                {step.title}
                            </h3>
                            <p className="text-[10px] text-slate-600 font-bold uppercase tracking-widest hidden sm:block">
                                {step.description}
                            </p>
                        </div>
                    </div>
