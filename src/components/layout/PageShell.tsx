...
import { LayoutDashboard, UploadCloud, Database, Users, Settings, Menu, X, Building, TrendingUp, Plus, Calendar, CheckSquare, ShieldCheck, BrainCircuit, List } from 'lucide-react';
